...
int ring_buffer::read(float *data_ptr, int num_samples)
{
	...
	// If there is not enough data in buffer to fill read request dont read anything 
...
int ring_buffer::write(float *data_ptr, int num_samples)
{
	...
	// If there is not enough space in buffer to do the write request dont write anything 
...
int ring_buffer::get_size()
{
	return m_size;
}

int ring_buffer::get_space()
{
	return m_space;
}

int ring_buffer::get_read_space()
{
	return m_size - m_space;
}