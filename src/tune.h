...
public:
  tune(std::string track_path, double tempo, double track_start_time,
  ...
  void set_volume_ramp(double start_time, double end_time, double start_volume,
                       double end_volume, int num_steps);
